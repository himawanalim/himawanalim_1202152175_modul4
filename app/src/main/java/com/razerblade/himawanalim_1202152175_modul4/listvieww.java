package com.razerblade.himawanalim_1202152175_modul4;
...
public class listvieww extends AppCompatActivity {
    ...
    private String[] nama = {"JAMAL","NURDIN","CIKABANDUNG","NAD","FAIRLADY","KUSUMO","JOKO","SISWONO"
    ,"KATIEM","KASIMO","SUMO","JADAR"};
    @Override
